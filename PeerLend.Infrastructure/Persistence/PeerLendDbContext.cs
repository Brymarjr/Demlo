...
namespace PeerLend.Infrastructure.Persistence;
...
public class PeerLendDbContext : DbContext
{
    public PeerLendDbContext(DbContextOptions<PeerLendDbContext> options) : base(options)
    {
    }
